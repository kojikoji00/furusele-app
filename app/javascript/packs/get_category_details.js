...
$(function() {
	$('.first select[name="category_id"]').change(function() {
    var categoryId = $('.first select[name="category_id"] option:selected').attr("value");
...
$(function() {
	$('.second select[name="category_id"]').change(function() {
    var categoryId = $('.second select[name="category_id"] option:selected').attr("value");
    var categoryDetails = gon.category_details.filter( cat => cat.category_id == categoryId );
...
$(function() {
	$('.third select[name="category_id"]').change(function() {
    var categoryId = $('.third select[name="category_id"] option:selected').attr("value");
    var categoryDetails = gon.category_details.filter( cat => cat.category_id == categoryId );
